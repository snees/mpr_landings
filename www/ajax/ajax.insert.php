...
date_default_timezone_set("Asia/Seoul");
    ...
    */
    ...
    $intSql  = " insert into mpr_custlist (rcdate, brand, event_name, cname, chp, age, url, user_ip )";
    $intSql .= " values ('{$rcdate}', '{$result['cust_nm']}', '{$result['event_nm']}', '{$name}', '{$phone}', '{$age}', '{$result['event_url']}', '{$_SERVER['REMOTE_ADDR']}') ";
